...
# with command line options: l1Ntuple -s RAW2DIGI --python_filename=data_run3_2024.py --era=Run3 --data --conditions=140X_dataRun3_HLT_v3 --customise=L1Trigger/L1TNtuples/customiseL1Ntuple.L1NtupleRAW --no_exec
