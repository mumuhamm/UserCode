...
config.General.workArea = 'OMTF_PU140_PhaseI_Expo_ForRate'
config.General.requestName = 'OMTF_PU140_PhaseI_Expo_ForRate'
config.section_('JobType')
config.JobType.psetName = '/eos/user/a/almuhamm/01.MuonTech/LXPLUS8_MaxWorkDoneArea/CMSSW_14_0_0_pre2/src/UserCode/OmtfAnalysis/test/makeTree_PREmulation.py'
config.JobType.pluginName = 'Analysis'
config.JobType.outputFiles = ['omtfTree_MB_PU140.root']
